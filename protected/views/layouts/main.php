...
<head>
    ...
    <?php Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl.'/js/functions.js',CClientScript::POS_HEAD); ?>
    ...
    <div id="mainmenu">
        <?php $this->widget('zii.widgets.CMenu',array(
            'items'=>array(
                ...
                array('label'=>'Login', 'url'=>array('admin/index'), 'visible'=>Yii::app()->user->isGuest),
